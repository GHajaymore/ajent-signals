...
export function render(container) {
  ...
  <div class="fade-in glow-wrap detail-screen">
    ...
    <div class="panel">
      ...
      <div class="reason-row"><i class="ph-bold ph-flask" style="color:var(--accent-300)"></i><span><b style="color:var(--text)">Experiment, then proven.</b> A newer cell (FX, commodities) that passes the gate ships clearly labelled <b>experimental</b> and is tracked on the live record. It only earns the <b>proven</b> label once that <b>real forward record</b> confirms the edge — the backtest gets it onto the board, the live results graduate it.</span></div>
    </div>
