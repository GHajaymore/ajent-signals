  ...
  <div class="fade-in glow-wrap">
    ...
    <div class="panel setting-block">
      ...
      <div class="setting-help" id="mode-help" style="margin-top:10px">${state.settings.strategyMode === 'intraday'
        ? 'Active mode — 15-minute Connors mean reversion, long-only. Buys oversold dips (RSI2 below 15) in an intraday uptrend and exits when RSI2 recovers past 50. Tuned for frequency: ~30+ setups a day across US, European &amp; Asian indices plus crypto (BTC/ETH) and metals/energy futures (Silver, Crude) — many trading nearly 24/7. Backtested ~66% win, profit factor up to ~2.2 on the strongest markets and ~1.2 on the marginal ones — but on ~60 days of data only, so treat it as provisional until the live paper record confirms it.'
